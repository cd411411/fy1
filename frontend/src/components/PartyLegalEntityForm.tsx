...
export const PartyLegalEntityForm: React.FC<{ path: string, specialType?: string }> = ({ path, specialType }) => {
      ...
      <div className="grid grid-cols-6 gap-x-6 gap-y-4">
        ...
        {specialType === "不予执行申请书" && (
          <div className="form-control col-span-6">
            <label className="label py-1"><span className="label-text">身份</span></label>
            <div className="flex flex-wrap gap-4">
              <label className="flex items-center gap-1">
                <input type="radio" {...register(`${path}.identityType`)} value="被执行人" className="radio radio-sm" />
                被执行人
              </label>
              <label className="flex items-center gap-1">
                <input type="radio" {...register(`${path}.identityType`)} value="案外人" className="radio radio-sm" />
                案外人
              </label>
              <label className="flex items-center gap-1">
                <input type="radio" {...register(`${path}.identityType`)} value="其他" className="radio radio-sm" />
                其他
              </label>
              <div className="flex items-center gap-1">
                <input 
                  type="text" 
                  {...register(`${path}.identityTypeOther`)} 
                  placeholder="请说明" 
