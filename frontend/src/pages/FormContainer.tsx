...
// ==========================================application=======================================================
'application-non-enforcement-of-arbitration': lazy(() => import('../forms/application/NonEnforcementOfArbitrationFormPage.tsx')),
// 'application-participate-in-distribution': lazy(() => import('../forms/application/ParticipateInDistributionFormPage.tsx')),
// 'application-wrongful-enforcement-compensation': lazy(() => import('../forms/application/WrongfulEnforcementCompensationFormPage.tsx')),
// 'application-failure-of-supervision-duty-compensation': lazy(() => import('../forms/application/FailureOfSupervisionDutyCompensationFormPage.tsx')),
'application-compulsory-enforcement': lazy(() => import('../forms/application/CompulsoryEnforcementFormPage.tsx')),
// 'application-confirm-right-of-first-refusal': lazy(() => import('../forms/application/ConfirmRightOfFirstRefusalFormPage.tsx')),
// 'application-lift-travel-restrictions': lazy(() => import('../forms/application/LiftTravelRestrictionsFormPage.tsx')),
'application-enforcement-guarantee': lazy(() => import('../forms/application/EnforcementGuaranteeFormPage.tsx')),
'application-enforcement-reconsideration': lazy(() => import('../forms/application/EnforcementReconsiderationFormPage.tsx')),
'application-enforcement-supervision': lazy(() => import('../forms/application/EnforcementSupervisionFormPage.tsx')),
'application-enforcement-objection': lazy(() => import('../forms/application/EnforcementObjectionFormPage.tsx')),
