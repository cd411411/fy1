...
import { AIUsageStatsPage } from "./pages/admin/AIUsageStatsPage";
import { RAGModelsPage } from "./pages/admin/RAGModelsPage";
import { VectorStoreManagementPage } from "./pages/admin/VectorStoreManagementPage";
            ...
            <BackgroundTaskProvider>
              ...
              <Routes>
                ...
                <Route path="/" element={<MainLayout />}>
                  ...
                  <Route
                    path="select-type/:docType"
                    element={<DocumentTypeSelection />}
                  />
                  <Route
                    path="select-template/:docType/:category"
                    element={<TemplateSelection />}
                  />
                  <Route
                    path=":docType/:formName"
                ...
                >
                  ...
                  {/* /admin 默认跳转到 dashboard */}
                  <Route path="dashboard" element={<DashboardPage />} />
                  <Route path="pending-cases" element={<PendingCasesPage />} />
                  <Route path="all-cases" element={<AllCasesPage />} />
                  <Route
                    path="cases/:caseNumber"
                    element={<AdminCaseDetailPage />}
                  />
                  <Route path="ai-models" element={<AIModelsPage />} />
                  <Route
                    path="filing-review/:caseNumber"
                    element={<FilingReviewPage />}
                  />
                  <Route
                    path="judgement/:caseNumber"
                    element={<CaseJudgementPage />}
                  />
                  <Route
                    path="feature-settings"
                    element={<FeatureSettingsPage />}
                  />
                  <Route path="ai-usage-stats" element={<AIUsageStatsPage />} />
                  <Route path="rag-models" element={<RAGModelsPage />} />
                  <Route
                    path="vector-stores"
